...
> **Этот архив — начальный каркас проекта.** Папки и пустые файлы реализации уже созданы. Приложение, зависимости, конфигурация и тесты ещё не реализованы; команды ниже пока не запускают рабочее решение. Начните с [TEAM.md](TEAM.md), затем согласуйте [контракты](docs/CONTRACTS.md). Исходные датасеты и погодный кэш в архив не включены.
